...
1. Snorkeling in rivers and creeks, backpacking, and hiking with my family,
...
```{r me_pic, echo=FALSE, out.width="250px"}
knitr::include_graphics("images/eric.jpg", auto_pdf = TRUE)
```

For whatever reason, the out.width argument is not respected by the R Notebook format.
Whatever.
...
estimating propoprtions of salmon from different rivers that were being
